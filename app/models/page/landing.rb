class Page::Landing < Page
  ...
  has_many :strapline_entry_points, -> { order(:position) }, as: :linkable, class_name: 'Link::StraplineEntryPoint', dependent: :destroy
  ...
  accepts_nested_attributes_for :strapline_entry_points, allow_destroy: true
